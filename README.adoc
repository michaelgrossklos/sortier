...
:imagesdir: images
:url-users-home:https://en.wikipedia.org/wiki/Home_directory
...
That is the relative path (from the {url-users-home}[users home directory]) to your source folder, where all the files are in.
