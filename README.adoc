...
[source,json]
include::sortier/sortier.json[]

ifdef::env-github[]

    <<https://raw.githubusercontent.com/michaelgrossklos/sortier/main/sortier/sortier.json?token=ABSN5FBXULFMTH76BKPA7WLAAX6IY#sortier.json, Sortier Config File>>
endif::[]
